...
export default function WarrantiesPage() {
  ...
  const fetchWarranties = async () => {
    try {
      ...
      if (selectedStatus && selectedStatus.trim()) params.append("status", selectedStatus);
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => setSelectedPurchaseFrom(value === "all" ? "" : value)}
                >
                  <SelectTrigger className="w-full">
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          <Button
                            ...
                            className="gap-2"
                            onClick={() =>
                              router.push(`/admin/warranties/${warranty.external_id}`)
                            }
                          >
